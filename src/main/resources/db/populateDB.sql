...
INSERT INTO recipe (name, recipe, calories, cookingtime) VALUES
...
Remove chicken from the oil and transfer to a cooling rack set over a paper towel lined baking sheet. Let sit for 10 minutes before serving.', 400, 60),
...
Transfer to hot plates and serve with a generous spoonful or two of sauce. Sprinkle with chives.', 600, 80),
...
Broil about 10 inches from the heat source until sauce is bubbling and cheese is lightly browned, 5 to 6 minutes. Transfer to serving plates lined with napkins to prevent shells from tipping; garnish each portion with 2 crossed tarragon leaves.', 500, 40),
...
Grill the chicken thighs until they are no longer pink in the middle and show grill marks, about 25 minutes, basting them generously with the sterilized marinade as they grill.', 300, 30),
...
Heat olive oil in a large skillet. Fry meatballs in batches. When the meatball is very brown and slightly crisp remove from the heat and drain on a paper towel. (If your mixture is too wet, cover the meatballs while they are cooking so that they hold their shape better.)', 600, 80),
...
Bake in preheated oven for 15 minutes, or until golden brown. Serve warm.', 250, 35),
...
Finally, stir in scrambled eggs and 1/3 cup soy sauce, heat through and serve hot.', 350, 80),
...
Preheat oven to 350 degrees F (180 degrees C). Place empanadas on a parchment paper lined baking sheet. Be sure to prick each empanada with a fork near the curl to allow steam to escape during baking. Glaze with egg for shine and bake until golden, about 20 to 30 minutes.', 500, 120),
...
Cook in wok or frying pan until brown, about 5 minutes. Add sesame seeds and cook for additional 2 minutes.', 400, 70),
...
Sprinkle lemon zest and drizzle lemon juice over the chicken.', 300, 380),
...
Cook on High until the beef is tender, 2 to 3 hours. Alternately, you can cook this on Low for 4 to 5 hours.', 300, 1050);